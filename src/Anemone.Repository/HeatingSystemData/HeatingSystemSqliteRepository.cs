...
select last_insert_rowid()";
    ...
    public async Task<HeatingSystem?> Get(int id)
    {
        using var connection = GetConnection();
        connection.Open();
        ...
        try
        {
            ...
            var heatingSystemData = await connection.QuerySingleOrDefaultAsync<HeatingSystem>(sql, parameters);
    ...
    public async Task<IEnumerable<HeatingSystem>> GetAll()
    {
        using var connection = GetConnection();
        connection.Open();
        ...
        try
        {
            ...
            var heatingSystems = (await connection.QueryAsync<HeatingSystem>(sql)).ToList();
    ...
    public async Task Update(HeatingSystem data)
    {
        using var connection = GetConnection();
        connection.Open();
        using var tr = connection.BeginTransaction();
    ...
    public async Task Delete(HeatingSystem data)
    {
    ...
    private static async Task UpdatePoints(IDbConnection connection, HeatingSystem heatingSystem)
    {
        if (heatingSystem.Id is null)
