...
public class HeatingSystemSqliteRepositoryTests : IClassFixture<DatabaseFixture>, IDisposable
{
    ...
    public async Task Create_WhenDataIsValid()
    {
        ...
        var actualHeatingSystem = await GetConnection()
            .QuerySingleAsync<Core.Common.Entities.HeatingSystem>("select * from HeatingSystem where Id = @Id",
                new { model.Id });
    ...
    public async Task Update_Name()
    {
        ...
        var actual = await GetConnection()
            .QuerySingleAsync<Core.Common.Entities.HeatingSystem>("select * from HeatingSystem where Id = @Id", new { expected.Id });
    ...
    public async Task Delete()
    {
        ...
        var actualHeatingSystem = await GetConnection()
            .QuerySingleOrDefaultAsync<Core.Common.Entities.HeatingSystem>("select * from HeatingSystem where Id = @Id",
                new { expected.Id });
    ...
    private async Task InsertPointsIntoDb(DateTime creationDate, Core.Common.Entities.HeatingSystem heatingSystem, int heatingSystemId)
    {
