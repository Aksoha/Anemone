...
namespace Anemone.Infrastructure.Tests.ReportGenerator;
...
public class ReportGeneratorTests
{
    ...
    private Infrastructure.Export.ReportGenerator? ReportGenerator { get; set; }
    ...
    {
        var loggerMock = new Mock<ILogger<Infrastructure.Export.ReportGenerator>>();
        ReportGenerator = new Infrastructure.Export.ReportGenerator(loggerMock.Object);
    }
